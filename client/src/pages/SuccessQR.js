  ...
  return (
    <div >
      ...
      <div className="container bg-red-100">
        <img className="mx-auto my-auto" alt="qr code" src="https://via.placeholder.com/350"></img>
      </div>

      <div className="container flow-root bg-green-100">
        <p className="text-center mt-10 mb-6" >Use this QR code to claim your car wash appointment in the reserved line</p>
        <br></br>
